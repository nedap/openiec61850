...
final class ServerThread extends Thread {
	...
	private final ServerTSap serverTSAP;
		...
		try {
			...
			while (true) {
				...
				if (numConnections < maxConnections) {
					...
					logger.warn("Transport Layer Server: Maximum number of connections reached. Ignoring connection request. NumConnections: "
							+ numConnections);
				}
